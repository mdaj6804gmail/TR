// ১. Variable কি ?
//উত্তরঃ ভেরিয়েবলের মধ্যে ডাটা সেভ করে রাখা যায়।
//যেমনঃ 
var a = 20;
console.log(a)
// ২. Variable কিভাবে লিখতে হয় ?
//উত্তরঃ ভেরিয়েবলের (var) দিয়ে লিখতে হয় ।

// ৩. string type variable কি ও কি ভাবে লিখতে হয় ?
// উত্তরঃ   ডাবল কোট বা ' ' সিঙ্গেল কোটের ভিতরে যা লেখা হয় ভ্যারিয়বেলের ভ্যালু তাকে স্ট্রিং  টাইপ ভ্যারিয়বেলের  (string  typevariable) বলা হয় । স্ট্রিং এর অর্থ টেক্সট ।

উদাহরণ : যেমনঃ var a = "websit"; console.log(a);
